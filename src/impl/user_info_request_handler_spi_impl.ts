...
import { UserInfoRequestHandlerSpiAdapter } from 'https://deno.land/x/authlete_deno_oak@v1.0.1/mod.ts';
import { UserDao } from '../db/user_dao.ts';


export class UserInfoRequestHandlerSpiImpl extends UserInfoRequestHandlerSpiAdapter
{
    public async getUserClaimValue(
        subject: string, claimName: string, languageTag?: string): Promise<any>
    {
